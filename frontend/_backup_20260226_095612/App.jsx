        ...
        <section className="lowerGrid">
          <div className="panel">
            <div className="panelHdr">
              ...
              <div className="panelSub">Placeholder until API exposes peak hits + unique peaks for current range.</div>
            </div>

            <div className="miniStats">
              <div className="mini">
                <div className="miniK">PEAKS BAGGED</div>
                <div className="miniV">—</div>
                <div className="miniS">in current range</div>
              </div>
              <div className="mini">
                <div className="miniK">UNIQUE PEAKS</div>
                <div className="miniV">—</div>
                <div className="miniS">lifetime unique</div>
              </div>
              <div className="mini">
                <div className="miniK">PROGRESS</div>
                <div className="miniV">—</div>
                <div className="miniS">towards target</div>
              </div>
            </div>

            <div className="coachSum">
              <div className="coachSumTitle">COACH SUMMARY</div>
              <div className="coachSumBody">Once peaks are wired, coach will call out what’s trending (new peaks, repeat patterns, etc.).</div>
            </div>
          </div>
