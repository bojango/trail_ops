...
# --- TrailOps bootstrap: ensure project root is on sys.path so `import app.*` works under Streamlit ---
import os as _os
import sys as _sys
...
# Ensure project root is on sys.path so `import app.*` works when Streamlit runs this file directly.
