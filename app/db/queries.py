    ...
    try:
        ...
        if _table_exists(conn, "workout_weather"):
            ...
            c_desc = pick("summary", "weather_summary", "conditions", "condition_text", "description")
                ...
                c_moon_name = pick("moon_phase_name")
    c_moon_illum = pick("moon_illumination")

select_cols = ["workout_id"]
            for c in (c_temp_c, c_temp_f, c_wind_kph, c_wind_mph, c_precip, c_precip_sum, c_cloud, c_code, c_desc, c_moon_name, c_moon_illum):
